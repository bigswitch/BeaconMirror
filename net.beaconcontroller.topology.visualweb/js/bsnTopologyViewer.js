/**
 * This is a light-weight wrapper around the jit library (thejit.org)'s implementation of
 * a force-directed graph.
 * 
 */

function bsnTopologyViewMain() {
    ...
    var bsnTopologyViewer = {
      fd : {},
      
      init: function(topology) {
          fd = constructFD(topology, 'topologyCanvas');
      },
      ...
      /**
       * Persists whatever data has been attached to this node to the back-end (see node.setData(), node.getData())
       */
